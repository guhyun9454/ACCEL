...
Usage (default reproduces the NeurIPS 2026 rebuttal P1-3 setup, RACE all split for task 'raceall'):
    python process.py
...
def main():
    ...
    parser.add_argument("--subset", default="all", choices=["high", "middle", "all"],
    ...
    test_path = write_split(test_rows, os.path.join(here, "test"), "raceall_test.csv")
    ...
    dev_path = write_split(dev_rows, os.path.join(here, "dev"), "raceall_dev.csv")
