...
Usage (default reproduces the NeurIPS 2026 rebuttal P1-3 setup, RACE-H test):
    python process.py
...
def main():
    ...
    parser.add_argument("--subset", default="high", choices=["high", "middle", "all"],
    ...
    test_path = write_split(test_rows, os.path.join(here, "test"), "race_test.csv")
    ...
    dev_path = write_split(dev_rows, os.path.join(here, "dev"), "race_dev.csv")
