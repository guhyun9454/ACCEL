...
USAGE (ARC, 4지선다):
  python router_with_pride.py --eval_name arc,0 --num_shifts 4 --lambda 0.80 --extra "--prompt_lang en"

USAGE (CSQA, 5지선다):
  python router_with_pride.py --eval_name csqa,0 --num_shifts 5 --lambda 0.80 --extra "--prompt_lang en"
"""
