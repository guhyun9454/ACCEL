...
def debias_results(debias_fn, load_path, save_path=None, by_category=None):
    ...
    for record_file in record_files:
        ...
        for d in data:
            meta = d['data'].get('meta', {})
            permuted_indices = meta.get('permuted_indices_list', None)
            observed, debiased, prior = debias_fn(d['data'][prob_name], permuted_indices=permuted_indices)
