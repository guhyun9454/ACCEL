...
SIGMA_METRIC_LABELS = {
    ...
    "same_set_n": "Same-set samples",
    "same_set_sigma_single": "Same-set single sigma",
    "same_set_sigma_two_view": "Same-set two-view sigma",
    "same_set_sigma_ratio": "Same-set ratio",
    "low_conf_n": "Low-conf samples",
    "mid_conf_n": "Mid-conf samples",
    "high_conf_n": "High-conf samples",
    "low_conf_sigma_single": "Low-conf single sigma",
    "low_conf_sigma_two_view": "Low-conf two-view sigma",
    "low_conf_sigma_ratio": "Low-conf ratio",
    "mid_conf_sigma_single": "Mid-conf single sigma",
    "mid_conf_sigma_two_view": "Mid-conf two-view sigma",
    "mid_conf_sigma_ratio": "Mid-conf ratio",
    "high_conf_sigma_single": "High-conf single sigma",
    "high_conf_sigma_two_view": "High-conf two-view sigma",
    "high_conf_sigma_ratio": "High-conf ratio",
    "paired_delta_abs_mean": "Paired delta |resid| mean",
    "paired_delta_abs_median": "Paired delta |resid| median",
    "paired_delta_sq_mean": "Paired delta resid^2 mean",
    "paired_delta_sq_median": "Paired delta resid^2 median",
    "paired_improve_rate_abs": "Paired improve rate |resid|",
    "paired_improve_rate_sq": "Paired improve rate resid^2",
    "paired_delta_abs_low_conf_mean": "Paired delta |resid| low-conf",
    "paired_delta_abs_mid_conf_mean": "Paired delta |resid| mid-conf",
    "paired_delta_abs_high_conf_mean": "Paired delta |resid| high-conf",
    "paired_improve_rate_abs_low_conf": "Paired improve rate low-conf",
    "paired_improve_rate_abs_mid_conf": "Paired improve rate mid-conf",
    "paired_improve_rate_abs_high_conf": "Paired improve rate high-conf",
    "records": "Samples",
}
...
def _format_sigma_table(df: pd.DataFrame) -> pd.DataFrame:
    ...
    metric_order = [
        ...
        "sigma_ratio_target",
        "same_set_n",
        "same_set_sigma_single",
        "same_set_sigma_two_view",
        "same_set_sigma_ratio",
        ...
        "mid_conf_n",
        "high_conf_n",
        "low_conf_sigma_single",
        "low_conf_sigma_two_view",
        "low_conf_sigma_ratio",
        "mid_conf_sigma_single",
        "mid_conf_sigma_two_view",
        "mid_conf_sigma_ratio",
        "high_conf_sigma_single",
        "high_conf_sigma_two_view",
        "high_conf_sigma_ratio",
        "paired_delta_abs_mean",
        "paired_delta_abs_median",
        "paired_delta_sq_mean",
        "paired_delta_sq_median",
        "paired_improve_rate_abs",
        "paired_improve_rate_sq",
        "paired_delta_abs_low_conf_mean",
        "paired_delta_abs_mid_conf_mean",
        "paired_delta_abs_high_conf_mean",
        "paired_improve_rate_abs_low_conf",
        "paired_improve_rate_abs_mid_conf",
        "paired_improve_rate_abs_high_conf",
        "records",
    ]
    cols = ["variant", "n_runs"]
